...
use Wow\UPush\Apple\IOSUnicast;
use Wow\UPush\Apple\IOSFilecast;
use Wow\UPush\Apple\IOSBroadcast;
use Wow\UPush\Apple\IOSGroupcast;
use Wow\UPush\Android\AndroidUnicast;
use Wow\UPush\Android\AndroidFilecast;
use Wow\UPush\Apple\IOSCustomizedcast;
use Wow\UPush\Android\AndroidBroadcast;
use Wow\UPush\Android\AndroidGroupcast;
use Wow\UPush\Android\AndroidCustomizedcast;
...
class Demo {
	...
	function sendAndroidBroadcast() {
		try {
			...
			$brocast->setPredefinedKeyValue("title",            "测试广播消息中文的title");
	...
	function sendIOSCustomizedcast() {
		try {
			...
			// And if you have many alias, you can also upload a file containing these alias, then
			// use file_id to send customized notification.
			// $customizedcast->setPredefinedKeyValue("alias", "497");
			// Set your alias_type here
			// $customizedcast->setPredefinedKeyValue("alias_type", "uidType");
